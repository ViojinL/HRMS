...
class AuditLog(models.Model):
    ...
    table_name = models.CharField(
        max_length=50, verbose_name="模块/表名", null=True, blank=True
    )
    record_id = models.CharField(
        max_length=200, verbose_name="记录ID/URL", null=True, blank=True
    )
    oper_type = models.CharField(
        max_length=20, choices=OPER_TYPE_CHOICES, verbose_name="操作类型"
    )
    summary = models.CharField(
        max_length=200, null=True, blank=True, verbose_name="操作摘要"
    )
