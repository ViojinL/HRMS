    ...
    class Meta:
        ...
        widgets = {
            ...
            "attendance_weight": forms.NumberInput(
                attrs={"class": "form-input block w-full", "min": 0, "max": 100}
            ),
            "leave_weight": forms.NumberInput(
                attrs={"class": "form-input block w-full", "min": 0, "max": 100}
            ),
        }
...
class PerformanceAdminEvaluationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "final_remark": forms.Textarea(
                attrs={"class": "form-textarea block w-full", "rows": 3}
            ),
            "evaluation_status": forms.Select(
                attrs={"class": "form-select block w-full"}
            ),
