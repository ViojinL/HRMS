...
class LeaveApply(BaseModel):
    ...
    leave_type = models.CharField(
        max_length=20, choices=LEAVE_TYPE_CHOICES, verbose_name="请假类型"
    )
    ...
    reason = models.TextField(null=True, blank=True, verbose_name="请假事由")
    attachment_url = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="附件路径"
    )
    total_days = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="总天数"
    )
    ...
    def __str__(self):
        # get_leave_type_display is generated by Django for choices; ignored for type checker.
        return f"{self.emp.emp_name} - {self.get_leave_type_display()}"  # type: ignore[attr-defined]
...
class LeaveTimeSegment(BaseModel):
    ...
    segment_days = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="该段天数"
    )
