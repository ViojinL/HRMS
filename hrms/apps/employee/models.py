...
class Employee(BaseModel):
    ...
    employment_type = models.CharField(
        max_length=20, choices=EMPLOYMENT_TYPE_CHOICES, verbose_name="雇佣类型"
    )
    emp_status = models.CharField(
        max_length=20, choices=EMP_STATUS_CHOICES, verbose_name="员工状态"
    )
...
class EmployeeHistory(BaseModel):
    ...
    change_reason = models.CharField(
        max_length=200, verbose_name="变更原因", null=True, blank=True
    )
