...
class Attendance(BaseModel):
    ...
    attendance_type = models.CharField(
        max_length=20, choices=TYPE_CHOICES, verbose_name="考勤类型"
    )
    check_in_time = models.DateTimeField(
        null=True, blank=True, verbose_name="上班打卡时间"
    )
    check_out_time = models.DateTimeField(
        null=True, blank=True, verbose_name="下班打卡时间"
    )
    attendance_status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, verbose_name="考勤状态"
    )
    exception_reason = models.TextField(null=True, blank=True, verbose_name="异常原因")
...
class AttendanceShift(BaseModel):
    shift_name = models.CharField(
        max_length=64, verbose_name="班次名称", default="默认班次"
    )
    ...
    create_by = models.CharField(max_length=64, default="system", verbose_name="创建人")
    update_by = models.CharField(max_length=64, default="system", verbose_name="更新人")
